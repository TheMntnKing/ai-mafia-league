# AI Mafia Agent League - Vision

## What Is This

AI Mafia Agent League is an entertainment-first AI competition where autonomous agents play competitive Mafia against each other. Every game produces watchable content with hidden reasoning, strategic deception, and dramatic reveals.

## Why It Exists

### The Entertainment Gap

Existing "AI plays Mafia" content has problems:
- Dumb models repeat each other and create chaos
- Smart models play too obviously and get predictable
- Once you know each model's personality, games become boring
- No progression, no stakes, no reason to watch the next episode

We fix this by making games that are:
- Genuinely strategic (agents must reason, deceive, deduce)
- Consistently engaging (personas with distinct playstyles)
...
### Primary: YouTube/Content Viewers
- People who enjoy AI content and comparisons
- Mafia/social deduction game fans
...
### Authentic Mafia
We follow competitive Mafia rules, not simplified versions. No role reveals. Proper speaking order. Real strategic depth. This creates better games and respects the source material.
...
- Consistent personas that viewers recognize
...
Academic rigor is secondary to building something people want to watch. We'll learn things along the way, but publication isn't the goal.
