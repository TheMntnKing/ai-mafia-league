...
Seven players: 2 Mafia, 1 Detective, 4 Town.

**Mafia** know each other. Each night they collectively kill one Town player. They win when they equal or outnumber Town.
...
Roles are assigned randomly. Each player learns only their own role, except Mafia who also learn their partner's identity.

### Night Zero

Before the first day, Mafia have a coordination phase. They do not kill anyone but may discuss strategy, agree on signals, or plan their approach. Detective does not act during night zero.
...
Mafia privately choose a player to kill. They may skip the night kill, though this is strategically rare. Detective privately chooses a player to investigate and learns the result. Night ends and the kill (if any) is announced.
